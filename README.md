...
![version](https://img.shields.io/badge/version-2.0.262-blue)
...
### 体验 · Experience
- iOS 风格界面，统一系统蓝与分组列表样式（含按钮 / 输入 / 卡片 / 滑动开关组件），支持深色 / 浅色配色切换。
- 中英文双语界面一键切换。
...
> [!NOTE]
> 本仓库为**发布产物仓库**，包含的是已构建产物 `dist/` 而非源码工程。技术栈由 `dist/` 中的 vendor 分包推断；版本与变更记录见 [`manifest.json`](manifest.json)。
...
<sub>作者 · Author：猫猫 (mzrodyu) · 仓库 · Repo：<https://github.com/iulove1314520/maomaomz-release></sub>
